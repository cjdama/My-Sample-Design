          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="contents text-center">
                <h2 class="head-title wow fadeInUp">WE DISCOVER, DESIGN & BUILD DIGITAL</h2>
     
                <h2 class="head-title1 wow fadeInUp">PRESENCE OF BUSINESSES</h2>
                <div class="header-button wow fadeInUp" data-wow-delay="0.3s">
                  <a href="#services" class="btn btn-common">Get Started</a>
                </div>
              </div>
